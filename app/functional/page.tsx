...
export default function FunctionalPage() {
  ...
  const hotspots: Hotspot[] = [
    ...
    },
    {
      id: 16,
      label: "CHANGE PHONE",
      descriptionFile: "change_phone.tsx",
      image: "",
      left: "96.8%",
      top: "24.3%",
    },
    {
      ...
      descriptionFile: "discount_level.tsx",
      image: "",
      left: "81.3%",
      top: "31.2%",
    },
    {
      ...
      descriptionFile: "discount_percentage.tsx",
      image: "",
      left: "86.6%",
      top: "31.2%",
    },
    {
      ...
      descriptionFile: "discount_amount.tsx",
      image: "",
      left: "91.7%",
      top: "31.3%",
    },
    {
      ...
      descriptionFile: "discount_remove.tsx",
      image: "",
      left: "96.8%",
      top: "31.4%",
    },
    ...
    },
    {
      id: 25,
      label: "NEW LOYALTY",
      descriptionFile: "new_loyalty.tsx",
      image: "",
      left: "81.4%",
      top: "45%",
    },
    ...
    },
    {
      ...
      descriptionFile: "recive_acc.tsx",
      image: "",
      left: "91.7%",
      top: "45.1%",
    },
    {
      ...
      descriptionFile: "manual_card_payment.tsx",
      image: "",
      left: "96.9%",
      top: "45.1%",
    },
    ...
    },
    {
      ...
      descriptionFile: "customer_keypad.tsx",
      image: "",
      left: "39.6%",
      top: "72%",
      variant: "circle",
    },
    {
      id: 37,
      label: "Change side",
      descriptionFile: "change_side.tsx",
      image: "",
      left: "46%",
      top: "72%",
      variant: "circle",
    },
    {
      id: 38,
      label: "Refresh ERP",
      descriptionFile: "refresh_system.tsx",
      image: "",
      left: "52.4%",
      top: "72%",
      variant: "circle",
    ...
    },
    {
      id: 44,
      label: "STAFF CREDIT",
      descriptionFile: "staff_credit.tsx",
      image: "",
      left: "63%",
      top: "87.6%",
      variant: "rounded",
    ...
    },
    {
      id: 46,
      label: "OGF MANUAL",
      descriptionFile: "ogf_manual.tsx",
      image: "",
      left: "75.5%",
      top: "87.6%",
      variant: "rounded",
  ...
  return (
    <div className="p-6 bg-gray-900 min-h-screen text-gray-100 overflow-y-auto">
      <button
        onClick={() => router.push("/")}
      ...
      {activeHotspot && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-80 overflow-y-auto px-6 pt-52 pb-20">
          <div
            ...
            >
              <div className="relative w-full pb-[75%]" >
                <Image
                  src={section.image}
                  alt={section.title}
                  className="rounded-t-lg shadow-lg absolute top-0 left-0 w-[1200px] h-auto object-contain bg-gray-800"
                  style={{ margin: 0 }}
                  width={1000}
                  height={1000}
                />
                  ...
                  <HotspotButton
                    ...
                    onClick={() => {
                      if (clickedHotspotId === hotspot.id) {
                        ...
                        // Use the consolidated data instead of dynamic imports
                        const content =
                          descriptions[
                            hotspot.descriptionFile as keyof typeof descriptions
                ...
                {activeHotspot && showDescription && (
                  <div
                    className="absolute top-1/2 left-1/2 z-50 w-full -translate-x-1/2 -translate-y-1/2 flex justify-center items-center"
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="overflow-x-auto overflow-y-auto w-full max-h-[40vh] px-2 mb-2">
                        <div
                          className="markdown-body prose prose-invert"
